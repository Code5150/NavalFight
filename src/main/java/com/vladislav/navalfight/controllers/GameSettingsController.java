...
import com.vladislav.navalfight.server.SettingsData;
...
public class GameSettingsController {
    ...
    public void initialize() {
        ...
        shotsSlider.valueProperty().addListener((observable, oldValue, newValue) -> shotsValue.setText(Integer.toString(newValue.intValue())));
        ships1Slider.valueProperty().addListener((observable, oldValue, newValue) -> ships1Value.setText(Integer.toString(newValue.intValue())));
        ships2Slider.valueProperty().addListener((observable, oldValue, newValue) -> ships2Value.setText(Integer.toString(newValue.intValue())));
        ships3Slider.valueProperty().addListener((observable, oldValue, newValue) -> ships3Value.setText(Integer.toString(newValue.intValue())));
    ...
    public void gameButtonClicked() {
        ...
        try {
            ...
            GameFieldController.setSize(sizeSlider.valueProperty().intValue());
            RmiController.getServerMethods().initGame(new SettingsData(
                    sizeSlider.valueProperty().intValue(),
                    shotsSlider.valueProperty().intValue(),
                    ships1Slider.valueProperty().intValue(),
                    ships2Slider.valueProperty().intValue(),
                    ships3Slider.valueProperty().intValue(),
                    ships4Slider.valueProperty().intValue()
            ));
